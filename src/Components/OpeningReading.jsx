...
function OpeningReading({ data }) {
  ...
  const handleImageUpload = (event) => {
    ...
    if (remainingSlots <= 0) {
      setSnackbar({
        open: true,
        message: "ניתן להעלות מקסימום 5 תמונות",
        severity: "warning",
      });
      event.target.value = "";
      return;
    ...
    if (files.length > remainingSlots) {
      setSnackbar({
        open: true,
        message: `נבחרו רק ${remainingSlots} תמונות מתוך ${files.length} בגלל המגבלה של 5 תמונות`,
        severity: "info",
      });
    }
  ...
  return (
    <>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={6}>
            <FormControl fullWidth required>
              <InputLabel id="callType-label">סוג קריאה</InputLabel>
              <Select
              ...
              >
                <MenuItem sx={{ direction: "ltr" }} value="תקלה">
                  תקלה
                </MenuItem>
                <MenuItem sx={{ direction: "ltr" }} value="כיול">
                  כיול
                </MenuItem>
                <MenuItem sx={{ direction: "ltr" }} value="אחזקה מונעת">
                  אחזקה מונעת
                </MenuItem>
              </Select>
            </FormControl>
          ...
          <Grid item xs={12} md={6}>
            <FormControl fullWidth required>
              ...
              >
                <MenuItem sx={{ direction: "ltr" }} value="לא דחוף">
                  לא דחוף
                </MenuItem>
                <MenuItem sx={{ direction: "ltr" }} value="דחוף">
                  דחוף
                </MenuItem>
                <MenuItem sx={{ direction: "ltr" }} value="דחוף מאוד">
                  דחוף מאוד
                </MenuItem>
                <MenuItem sx={{ direction: "ltr" }} value="מושבת">
                  מושבת
                </MenuItem>
              </Select>
            </FormControl>
            ...
            >
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                <Box sx={{ display: "flex", gap: 1, alignItems: "center" }}>
                  ...
                  >
                    {formData.images.length}/5 תמונות
                  </Typography>
                </Box>
      ...
      <Dialog open={deleteConfirm.open} onClose={handleDeleteCancel} dir="rtl">
